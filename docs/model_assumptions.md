...
- `PYTHONPATH=backend uv run pytest -q`: `94 passed` in `101.91s` under Python `3.13.13` after adding the executable benchmark threshold gate and JSON evidence output; warnings are PuLP deprecations from optimizer tests.
