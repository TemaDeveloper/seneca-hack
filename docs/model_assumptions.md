...
- `PYTHONPATH=backend uv run pytest -q`: `96 passed` in `101.28s` under Python `3.13.13` after adding assumption-ledger coverage for model and runtime constants; warnings are PuLP deprecations from optimizer tests.
